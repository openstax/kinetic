...
module Api::V1::Bindings
  class NewStudy
    ...
    def hash
      [title_for_participants, title_for_researchers, short_description, long_description, tags, feedback_description, image_id, benefits, is_hidden, opens_at, closes_at, is_mandatory].hash
    end
