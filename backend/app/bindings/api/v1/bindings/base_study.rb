...
module Api::V1::Bindings
  class BaseStudy
    ...
    def hash
      [title_for_participants, title_for_researchers, short_description, long_description, tags, feedback_description, image_id, benefits, is_hidden, opens_at, closes_at, first_launched_at, researchers, is_mandatory, status, view_count, completed_count, study_type, stages].hash
    end
