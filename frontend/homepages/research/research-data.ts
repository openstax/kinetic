import AndrewLan from './images/members/Andrew Lan.png';
import Brittany from './images/members/Brittany.png';
import Chris from './images/members/Chris.png';
import DanielleMcNamara from './images/members/Danielle McNamara.png';
import Debshila from './images/members/Debshila.png';
import Fabrizio from './images/members/Fabrizio.png';
import FredOswald from './images/members/Fred Oswald.png';
import Hossein from './images/members/Hossein Babei.png';
import IrisG from './images/members/Iris.png';
import IrisZ from './images/members/Iris Zhong.png';
import Jack from './images/members/Jack Wang.png';
import Jeffrey from './images/members/Jeffery Zhong.png';
import Karyssa from './images/members/Karyssa Courey.png';
import Katie from './images/members/Katie.png';
import Lucy from './images/members/Lucy Liu.png';
import Makai from './images/members/Makai Ruffin.png';
import Margaret from './images/members/Margaret Beier.png';
import Nathan from './images/members/Nathan.png';
import PhilKortum from './images/members/Phil Kortum.png';
import Rich from './images/members/Rich.png';
import Ross from './images/members/Ross.png';
import Sabitha from './images/members/Sabitha.png';
import Shashank from './images/members/Shashank Sonkar.png';
import Viki from './images/members/Viki.png';
import Zihan from './images/members/Zihan Liu.png';
import UnderstandingLearners from './images/landing/understand-learners.png';
import Kinetic from './images/landing/kinetic.png';
import LanguageModels from './images/landing/language-models.png';
import Ontology from './images/landing/ontology.png';
import Raise from './images/landing/raise.png';
import Equip from './images/landing/equip.png';
    ...
    kinetic: [
        {
            ...
            shortDescription: 'To enrich learning research, we are building a library of learner characteristics measures (including socio-demographics, cognitive, motivational, and other psychosocial factors) that will be made available to Kinetic researchers.',
            image: UnderstandingLearners,
            cta: {
                text: 'Learn more about Learner Characteristics library on Kinetic',
                url: 'https://openstax.github.io/kinetic-learner-characteristics-lib//learner-lib.html#data-combo',
            },
            github: null,
            publication: null,
        },
        {
            ...
            shortDescription: 'Kinetic enables researchers to implement diverse research designs, securely analyze study data, and ultimately further research that translates promising findings into product offerings that benefit all learners on OpenStax and other platforms.',
            image: Kinetic,
            cta: {
    ...
    ai: [
        {
            ...
            shortDescription: 'We investigated the impact of various prompting strategies on the quality of questions generated by large Pretrained Language Models and identified strategies that resulted in the best outcomes.',
    ...
    education: [
        {
            ...
            shortDescription: 'With RAISE, we aim to promote academic achievement in Algebra 1 with a focus on equity. RAISE is both an innovative curriculum and a platform for research that will iteratively improve according to what is effective for our students.',
            image: Raise,
            cta: {
        ...
        },
        {
            ...
            shortDescription: 'An intervention of teacher professional development and classroom access to OpenStax tutor was used to help reduce inequities in AP course outcomes for underrepresented students. Teachers and students perceived the intervention as being helpful especially during the pandemic.',
            image: Equip,
            cta: null,
            github: null,
            publication: null,
